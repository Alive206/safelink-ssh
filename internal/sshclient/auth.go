...
// loadSigner reads a private key file and returns an ssh.Signer.  It accepts
// PKCS#1, PKCS#8 and OpenSSH-format keys; ssh.ParsePrivateKey handles the
// container format detection itself.
