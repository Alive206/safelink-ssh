...
// expecting a reply.  After maxFails consecutive failures it returns an error
// so the supervisor can tear down and reconnect.  This mirrors OpenSSH's
// ServerAliveInterval / ServerAliveCountMax semantics.
